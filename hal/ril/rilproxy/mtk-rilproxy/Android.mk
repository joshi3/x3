...
LOCAL_C_INCLUDES := \
  ...
  $(TOP)/$(DEVICE_PATH)/hal/ril/rilproxy/libril \
  $(TOP)/$(DEVICE_PATH)/hal/ril/rilproxy/mtk-rilproxy/framework/include \
  $(TOP)/$(DEVICE_PATH)/hal/ril/rilproxy/mtk-rilproxy/framework/include/base \
  $(TOP)/$(DEVICE_PATH)/hal/ril/rilproxy/mtk-rilproxy/framework/include/core \
  $(TOP)/$(DEVICE_PATH)/hal/ril/rilproxy/mtk-rilproxy/telephony \
  $(TOP)/$(DEVICE_PATH)/hal/ril/rilproxy/mtk-rilproxy/telephony/ir/include \
  $(TOP)/$(DEVICE_PATH)/hal/ril/rilproxy/mtk-rilproxy/telephony/nw \
  $(TOP)/$(DEVICE_PATH)/hal/ril/rilproxy/mtk-rilproxy/telephony/wp \
  $(TOP)/$(DEVICE_PATH)/hal/ril/include/mal_header/include/ \
...
LOCAL_C_INCLUDES += $(TOP)/$(DEVICE_PATH)/hal/ril/include/audio
LOCAL_SHARED_LIBRARIES += libaudioprimarydevicehalifclient

#ifneq ($(MTK_EMULATOR_SUPPORT),yes)

LOCAL_C_INCLUDES += $(TOP)/$(DEVICE_PATH)/hal/ril/libnvram \
                    $(LOCAL_PATH)/../../include
...
LOCAL_C_INCLUDES += $(TOP)/$(DEVICE_PATH)/hal/ril/rilproxy/librilutils
