...
{RIL_REQUEST_EMERGENCY_DIAL, dialToParcel, parcelToVoid},
{RIL_REQUEST_SET_ECC_SERVICE_CATEGORY, intsToParcel, parcelToVoid},
...
/// M: CC: For 3G VT only @{
{RIL_REQUEST_VT_DIAL, dialToParcel, parcelToVoid},
{RIL_REQUEST_VOICE_ACCEPT, intsToParcel, parcelToVoid},
{RIL_REQUEST_REPLACE_VT_CALL, intsToParcel, parcelToVoid},
/// @}
{RIL_REQUEST_CURRENT_STATUS, intsToParcel, parcelToVoid}, // Verizon E911
...
{RIL_REQUEST_RELOAD_MODEM_TYPE, intsToParcel, parcelToVoid},
{RIL_REQUEST_STORE_MODEM_TYPE, intsToParcel, parcelToVoid},
...
{RIL_REQUEST_SYNC_APN_TABLE, stringsToParcel, parcelToVoid},
...
{RIL_REQUEST_SET_IMS_VOICE_ENABLE, intsToParcel, parcelToVoid},
...
{RIL_REQUEST_IMS_BEARER_ACTIVATION_DONE, stringsToParcel, parcelToVoid},
{RIL_REQUEST_IMS_BEARER_DEACTIVATION_DONE, stringsToParcel, parcelToVoid},
...
{RIL_REQUEST_SEND_USSI, stringsToParcel, parcelToVoid},
...
// [IMS] Emergency Dial
{RIL_REQUEST_IMS_EMERGENCY_DIAL, dialToParcel, parcelToVoid},
{RIL_REQUEST_SET_IMS_REGISTRATION_REPORT, voidToParcel, parcelToVoid},
// External SIM [START]
