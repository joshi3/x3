...
void ril_socket_init() {
    ...
    socketName = RilpSocketUtil::getSocketName(RADIO_TECH_GROUP_SAP_GSM, RIL_SOCKET_ID(0));
    SapRilProxyRildSocket::initSocket(socketName, RIL_SOCKET_ID(0), RADIO_TECH_GROUP_SAP_GSM);
    if (RpFeatureOptionUtils::isC2kSupport()) {
