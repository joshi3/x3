...
public class MT6795 extends RIL implements CommandsInterface {
    ...
    static final int RIL_REQUEST_MODEM_POWEROFF = 2010;
//    static final int RIL_REQUEST_DUAL_SIM_MODE_SWITCH  = 2011;
//    static final int RIL_REQUEST_USIM_AUTHENTICATION  = 2027;
    static final int RIL_REQUEST_MODEM_POWERON = 2028;
    static final int RIL_REQUEST_RESUME_REGISTRATION  = 2065;
//    static final int RIL_REQUEST_SIM_INTERFACE_SWITCH  = 2068;
    static final int RIL_REQUEST_SET_CALL_INDICATION = 2086;
    static final int RIL_REQUEST_EMERGENCY_DIAL = 2087;
    static final int RIL_REQUEST_SET_ECC_SERVICE_CATEGORY = 2088;
    static final int RIL_REQUEST_SET_ECC_LIST = 2089;
    static final int RIL_REQUEST_GENERAL_SIM_AUTH = 2090;
    static final int RIL_REQUEST_QUERY_AVAILABLE_NETWORK_WITH_ACT = 2095;
    static final int RIL_REQUEST_SWITCH_CARD_TYPE = 20131;
    ...
    static final int RIL_UNSOL_INCOMING_CALL_INDICATION = 3042;
    static final int RIL_UNSOL_CALL_INFO_INDICATION = 3049;
    static final int RIL_UNSOL_MD_STATE_CHANGE = 3053;
    static final int RIL_UNSOL_SET_ATTACH_APN = 3073;
